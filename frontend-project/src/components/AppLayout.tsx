...
import { ParticleCanvas } from "./three";
...
const MobileNav = () => {
        ...
        return (
                <div className="mobile-nav">
                        ...
                        >
                                <span className="mobile-nav__trigger-icon">{isOpen ? <FiX /> : <FiMenu />}</span>
...
const AppLayout = () => {
        ...
        return (
                <div className="app-layout relative min-h-screen bg-[#020202]">
                        {/* Ambient three.js particle field — fixed to viewport so it never
                            contributes to document scroll height. */}
                        <ParticleCanvas
                                count={180}
                                spread={36}
                                size={0.08}
                        ...
                        />
                        <Sidebar />
                        <div className="app-main relative z-10 w-full flex-1 bg-transparent">
                                <MobileNav />
                                <Header />
